<template>
  <div class="relative min-h-screen">
    ...
    <section class="content bg-blanc -mt-5 py-8 px-5 z-10 relative border border-blanc rounded-3xl">
        <h1>Le parcours de visite</h1>
        <p>Découvrez en un clin d’œil les grandes étapes abordées dans cette visite.</p>
        <h2 class="mb-4">L’École de formation des juges et des procureurs</h2>
         <ScrollHorizontal>
...
const cardsParcours2 = [
  ...
  { title: 'Le fort du Hâ, lieu de la répression durant l’Occupation à Bordeaux', position: 'Monument aux morts', img: Monument, alt: 'Monument aux morts dans la cours de l ENM', link:'/qr/monument-aux-morts'},
